...
namespace Gest.SqlServerMigration.Migrations
{
    ...
    [Migration("20220324204906_AddExpenses")]
            ...
            modelBuilder.Entity("Gest.Core.Entities.Branch", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedAt = new DateTime(2022, 3, 24, 20, 49, 5, 972, DateTimeKind.Utc).AddTicks(8187),
                            FCToDollarRate = 2000m,
                            Name = "Default",
                            UpdatedAt = new DateTime(2022, 3, 24, 20, 49, 5, 972, DateTimeKind.Utc).AddTicks(8179)
                        });
                });
            ...
            modelBuilder.Entity("Gest.Core.Entities.Client", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CompanyId = new Guid("afdc3370-adb1-4de9-ad12-7678145b4485"),
                            CreatedAt = new DateTime(2022, 3, 24, 20, 49, 5, 972, DateTimeKind.Utc).AddTicks(8194),
                            Email = "clientanonyme@swala.com",
                            Names = "Client Anonyme",
                            UpdatedAt = new DateTime(2022, 3, 24, 20, 49, 5, 972, DateTimeKind.Utc).AddTicks(8191)
                        });
                });
            ...
            modelBuilder.Entity("Gest.Core.Entities.Company", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Adress = "Bunia",
                            CreatedAt = new DateTime(2022, 3, 24, 20, 49, 5, 972, DateTimeKind.Utc).AddTicks(8176),
                            FCToDollarRate = 2000m,
                            Name = "Ets TUUNGANE",
                            UpdatedAt = new DateTime(2022, 3, 24, 20, 49, 5, 972, DateTimeKind.Utc).AddTicks(8174)
                        });
                });
            ...
            modelBuilder.Entity("Gest.Core.Entities.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedAt = new DateTime(2022, 3, 24, 20, 49, 5, 972, DateTimeKind.Utc).AddTicks(8123),
                            Email = "admin@swala.com",
                            FirstName = "Admin",
                            LastName = "Swala",
                            PasswordHash = "",
                            PasswordSalt = "KYU7Gy/sWGFB5vV991yjPeUMj3dcKYW6stMWQFP6eZ7H7fD5C/7q15A+uD4rAf1seuiIxr6jaZDcbbxKAphJMw==",
                            UpdatedAt = new DateTime(2022, 3, 24, 20, 49, 5, 972, DateTimeKind.Utc).AddTicks(8087)
                        });
                });
            ...
            modelBuilder.Entity("Gest.Core.Entities.UserCompany", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CompanyId = new Guid("afdc3370-adb1-4de9-ad12-7678145b4485"),
                            Joined = new DateTime(2022, 3, 24, 20, 49, 5, 972, DateTimeKind.Utc).AddTicks(8137),
                            Role = "Propriétaire",
