...
namespace Gest.SqlServerMigration.Migrations
{
    ...
    [Migration("20220324205717_AddExpenses2")]
            ...
            modelBuilder.Entity("Gest.Core.Entities.Branch", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedAt = new DateTime(2022, 3, 24, 20, 57, 16, 666, DateTimeKind.Utc).AddTicks(2149),
                            FCToDollarRate = 2000m,
                            Name = "Default",
                            UpdatedAt = new DateTime(2022, 3, 24, 20, 57, 16, 666, DateTimeKind.Utc).AddTicks(2146)
                        });
                });
            ...
            modelBuilder.Entity("Gest.Core.Entities.Client", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CompanyId = new Guid("afdc3370-adb1-4de9-ad12-7678145b4485"),
                            CreatedAt = new DateTime(2022, 3, 24, 20, 57, 16, 666, DateTimeKind.Utc).AddTicks(2155),
                            Email = "clientanonyme@swala.com",
                            Names = "Client Anonyme",
                            UpdatedAt = new DateTime(2022, 3, 24, 20, 57, 16, 666, DateTimeKind.Utc).AddTicks(2152)
                        });
                });
            ...
            modelBuilder.Entity("Gest.Core.Entities.Company", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Adress = "Bunia",
                            CreatedAt = new DateTime(2022, 3, 24, 20, 57, 16, 666, DateTimeKind.Utc).AddTicks(2144),
                            FCToDollarRate = 2000m,
                            Name = "Ets TUUNGANE",
                            UpdatedAt = new DateTime(2022, 3, 24, 20, 57, 16, 666, DateTimeKind.Utc).AddTicks(2142)
                        });
                });
            ...
            modelBuilder.Entity("Gest.Core.Entities.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedAt = new DateTime(2022, 3, 24, 20, 57, 16, 666, DateTimeKind.Utc).AddTicks(2128),
                            Email = "admin@swala.com",
                            FirstName = "Admin",
                            LastName = "Swala",
                            PasswordHash = "",
                            PasswordSalt = "d1Oaw5CmhClmY60X8bTC4RC6eMCIVMaJP/rQW6w8CH3UGYiPMykgH0kXKtGhGJJieWJOJ9FjyubuEEPTpUIEuQ==",
                            UpdatedAt = new DateTime(2022, 3, 24, 20, 57, 16, 666, DateTimeKind.Utc).AddTicks(2105)
                        });
                });
            ...
            modelBuilder.Entity("Gest.Core.Entities.UserCompany", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CompanyId = new Guid("afdc3370-adb1-4de9-ad12-7678145b4485"),
                            Joined = new DateTime(2022, 3, 24, 20, 57, 16, 666, DateTimeKind.Utc).AddTicks(2133),
                            Role = "Propriétaire",
