        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Price_PerUnitOfMeasure = table.Column<decimal>(type: "TEXT", nullable: false),
                    Price_PerConditionnement = table.Column<decimal>(type: "TEXT", nullable: true),
                    CompanyId = table.Column<Guid>(type: "TEXT", nullable: false),
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { new Guid("afdc3370-adb1-4de9-ad12-7678145b4485"), "Bunia", new DateTime(2022, 3, 3, 7, 24, 0, 618, DateTimeKind.Utc).AddTicks(3316), 2000m, "Ets TUUNGANE", new DateTime(2022, 3, 3, 7, 24, 0, 618, DateTimeKind.Utc).AddTicks(3314), null });

            migrationBuilder.InsertData(
                table: "Users",
                columns: new[] { "Id", "CreatedAt", "Email", "FirstName", "LastName", "PasswordHash", "PasswordSalt", "PhoneNumber", "ProfileUrl", "UpdatedAt" },
                values: new object[] { new Guid("d5ccad5b-6cbc-4993-96e3-e8cd7c76d8b9"), new DateTime(2022, 3, 3, 7, 24, 0, 618, DateTimeKind.Utc).AddTicks(3297), "admin@swala.com", "Admin", "Swala", "", "lD/8Mj8mgm7wr9A6G2dyIaMoie0Nk0jPWzDGypEp9n9uUITvx6rQsiaty5RdSL3fPQFLFZPOfOerVVCYaFjufw==", null, null, new DateTime(2022, 3, 3, 7, 24, 0, 618, DateTimeKind.Utc).AddTicks(3261) });

            migrationBuilder.InsertData(
                table: "Branches",
                columns: new[] { "Id", "CompanyId", "CreatedAt", "FCToDollarRate", "Name", "UpdatedAt" },
                values: new object[] { new Guid("453412a3-578b-446b-9406-bd7077bdce01"), new Guid("afdc3370-adb1-4de9-ad12-7678145b4485"), new DateTime(2022, 3, 3, 7, 24, 0, 618, DateTimeKind.Utc).AddTicks(3323), 2000m, "Default", new DateTime(2022, 3, 3, 7, 24, 0, 618, DateTimeKind.Utc).AddTicks(3318) });

            migrationBuilder.InsertData(
                table: "Clients",
                columns: new[] { "Id", "CompanyId", "CreatedAt", "Email", "Names", "Phone", "Type", "UpdatedAt", "WalletId" },
                values: new object[] { new Guid("654412a3-578b-446b-9406-bd7077bdce01"), new Guid("afdc3370-adb1-4de9-ad12-7678145b4485"), new DateTime(2022, 3, 3, 7, 24, 0, 618, DateTimeKind.Utc).AddTicks(3328), "clientanonyme@swala.com", "Client Anonyme", null, null, new DateTime(2022, 3, 3, 7, 24, 0, 618, DateTimeKind.Utc).AddTicks(3324), null });

            migrationBuilder.InsertData(
                table: "UserCompanies",
                columns: new[] { "CompanyId", "UserId", "Joined", "Role", "UpdatedAt" },
                values: new object[] { new Guid("afdc3370-adb1-4de9-ad12-7678145b4485"), new Guid("d5ccad5b-6cbc-4993-96e3-e8cd7c76d8b9"), new DateTime(2022, 3, 3, 7, 24, 0, 618, DateTimeKind.Utc).AddTicks(3306), "Propriétaire", new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified) });
