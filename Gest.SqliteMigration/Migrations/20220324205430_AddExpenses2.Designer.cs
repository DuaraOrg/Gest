...
namespace Gest.SqliteMigration.Migrations
{
    ...
    [Migration("20220324205430_AddExpenses2")]
            ...
            modelBuilder.Entity("Gest.Core.Entities.Branch", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedAt = new DateTime(2022, 3, 24, 20, 54, 29, 476, DateTimeKind.Utc).AddTicks(8559),
                            FCToDollarRate = 2000m,
                            Name = "Default",
                            UpdatedAt = new DateTime(2022, 3, 24, 20, 54, 29, 476, DateTimeKind.Utc).AddTicks(8518)
                        });
                });
            ...
            modelBuilder.Entity("Gest.Core.Entities.Client", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CompanyId = new Guid("afdc3370-adb1-4de9-ad12-7678145b4485"),
                            CreatedAt = new DateTime(2022, 3, 24, 20, 54, 29, 476, DateTimeKind.Utc).AddTicks(8565),
                            Email = "clientanonyme@swala.com",
                            Names = "Client Anonyme",
                            UpdatedAt = new DateTime(2022, 3, 24, 20, 54, 29, 476, DateTimeKind.Utc).AddTicks(8561)
                        });
                });
            ...
            modelBuilder.Entity("Gest.Core.Entities.Company", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Adress = "Bunia",
                            CreatedAt = new DateTime(2022, 3, 24, 20, 54, 29, 476, DateTimeKind.Utc).AddTicks(8516),
                            FCToDollarRate = 2000m,
                            Name = "Ets TUUNGANE",
                            UpdatedAt = new DateTime(2022, 3, 24, 20, 54, 29, 476, DateTimeKind.Utc).AddTicks(8494)
                        });
                });
            ...
            modelBuilder.Entity("Gest.Core.Entities.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedAt = new DateTime(2022, 3, 24, 20, 54, 29, 476, DateTimeKind.Utc).AddTicks(8461),
                            Email = "admin@swala.com",
                            FirstName = "Admin",
                            LastName = "Swala",
                            PasswordHash = "",
                            PasswordSalt = "JAT2wIhdInuJ8YjhFtb+xCKJ7uoq/dNzlWvCvdOlb84ogd716GixkOjvS1ud6h9pe0uFLbCd+woBjklfShBKEg==",
                            UpdatedAt = new DateTime(2022, 3, 24, 20, 54, 29, 476, DateTimeKind.Utc).AddTicks(8436)
                        });
                });
            ...
            modelBuilder.Entity("Gest.Core.Entities.UserCompany", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CompanyId = new Guid("afdc3370-adb1-4de9-ad12-7678145b4485"),
                            Joined = new DateTime(2022, 3, 24, 20, 54, 29, 476, DateTimeKind.Utc).AddTicks(8467),
                            Role = "Propriétaire",
