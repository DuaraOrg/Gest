...
namespace Gest.SqliteMigration.Migrations
{
    ...
    [Migration("20220324205008_AddExpenses")]
            ...
            modelBuilder.Entity("Gest.Core.Entities.Branch", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedAt = new DateTime(2022, 3, 24, 20, 50, 7, 916, DateTimeKind.Utc).AddTicks(9463),
                            FCToDollarRate = 2000m,
                            Name = "Default",
                            UpdatedAt = new DateTime(2022, 3, 24, 20, 50, 7, 916, DateTimeKind.Utc).AddTicks(9461)
                        });
                });
            ...
            modelBuilder.Entity("Gest.Core.Entities.Client", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CompanyId = new Guid("afdc3370-adb1-4de9-ad12-7678145b4485"),
                            CreatedAt = new DateTime(2022, 3, 24, 20, 50, 7, 916, DateTimeKind.Utc).AddTicks(9467),
                            Email = "clientanonyme@swala.com",
                            Names = "Client Anonyme",
                            UpdatedAt = new DateTime(2022, 3, 24, 20, 50, 7, 916, DateTimeKind.Utc).AddTicks(9465)
                        });
                });
            ...
            modelBuilder.Entity("Gest.Core.Entities.Company", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Adress = "Bunia",
                            CreatedAt = new DateTime(2022, 3, 24, 20, 50, 7, 916, DateTimeKind.Utc).AddTicks(9460),
                            FCToDollarRate = 2000m,
                            Name = "Ets TUUNGANE",
                            UpdatedAt = new DateTime(2022, 3, 24, 20, 50, 7, 916, DateTimeKind.Utc).AddTicks(9458)
                        });
                });
            ...
            modelBuilder.Entity("Gest.Core.Entities.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedAt = new DateTime(2022, 3, 24, 20, 50, 7, 916, DateTimeKind.Utc).AddTicks(9438),
                            Email = "admin@swala.com",
                            FirstName = "Admin",
                            LastName = "Swala",
                            PasswordHash = "",
                            PasswordSalt = "4PK83ckdchjBdJzR/7soFJTkEnChBtiEoTPavqZ2au2losiEerud21wHXBlqKtmrp4D83aHyyks0kKaMovwi3Q==",
                            UpdatedAt = new DateTime(2022, 3, 24, 20, 50, 7, 916, DateTimeKind.Utc).AddTicks(9412)
                        });
                });
            ...
            modelBuilder.Entity("Gest.Core.Entities.UserCompany", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CompanyId = new Guid("afdc3370-adb1-4de9-ad12-7678145b4485"),
                            Joined = new DateTime(2022, 3, 24, 20, 50, 7, 916, DateTimeKind.Utc).AddTicks(9448),
                            Role = "Propriétaire",
